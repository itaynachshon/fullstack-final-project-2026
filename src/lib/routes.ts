 ...
 *
 * V2 pages (`/settings`, `/chat`) are listed in `@/lib/v2/routes` and merged
 * into `isProtectedPagePath` so F2/F3 do not edit this file.
 */

import { V2_PROTECTED_PAGES } from "@/lib/v2/routes";
...
/** True for /fridge, /add, /restock, V2 pages, and nested segments under them. */
export function isProtectedPagePath(pathname: string): boolean {
  return [...PROTECTED_PAGES, ...V2_PROTECTED_PAGES].some((page) =>
    matchesBase(pathname, page),
  );
}

...
const RULES: CategoryRule[] = [
  ...
  },
  {
    ...
    patterns: [
      /רוטב/, /קטשופ/, /מיונז/, /חרדל/, /טחינה/, /חומוס/, /ממרח/, /ריבה/,
      /דבש/, /סילאן/, /חומץ/, /תבלין/, hebrewWord("שמן"),
      /sauce/i, /ketchup/i, /mayo/i, /mustard/i, /tahini/i, /hummus/i,
      /spread/i, /jam/i, /honey/i,
    ],
  },
  {
    category: "Snacks",
    patterns: [
      /במבה/, /ביסלי/, /חטיף/, /שוקולד/, /וופל/, /ופל/, /עוגי/, /עוגה/,
      /ביסקוויט/, /קרקר/, /מציות/, /צ'?יפס/, /פופקורן/, /סוכרי/, /מסטיק/,
      /snack/i, /chips/i, /chocolate/i, /cookie/i, /wafer/i, /candy/i,
    ],
  },
  {
    category: "Drinks",
    patterns: [
      /משקה/, /מיץ/, /קולה/, /סודה/, /בירה/, /לימונדה/, /קפה/, /שוקו/,
      /מינרל/, hebrewWord("תה"), hebrewWord("יין"), hebrewWord("מים"),
      /juice/i, /cola/i, /beer/i, /wine/i, /coffee/i, /\btea\b/i, /water/i,
      /drink/i, /soda/i,
    ],
  },
  {
    category: "Dairy",
    patterns: [
      /חלב/, /גבינ/, /יוגורט/, /קוטג/, /שמנת/, /חמאה/, /מעדן/, /מילקי/,
      /ריקוטה/, /מוצרלה/, /קממבר/, /בולגרית/, /צפתית/, hebrewWord("לבן"),
      hebrewWord("אשל"), hebrewWord("גיל"),
      /milk/i, /cheese/i, /yog(h?)urt/i, /butter/i, /cream/i, /cottage/i,
    ],
  },
  {
    category: "Meat & Fish",
    patterns: [
      /עוף/, /הודו/, /בקר/, /בשר/, /נקניק/, /קבב/, /המבורגר/, /שניצל/,
      /סלמון/, /טונה/, /פילה/, /כבד/, /פסטרמה/, /דגים/, hebrewWord("דג"),
      /chicken/i, /beef/i, /turkey/i, /tuna/i, /salmon/i, /\bfish\b/i,
      /sausage/i,
    ],
  },
  {
    category: "Prepared",
    patterns: [
      /סלט/, /מרק/, /פיצה/, /בורקס/, /מלוואח/, /ג'חנון/, /קציצות/, /מוכן/,
      /pizza/i, /soup/i, /salad/i, /ready/i,
    ],
  },
  {
    category: "Vegetables",
    patterns: [
      /תפוח אדמה/, /תפו"א/, /עגבני/, /מלפפון/, /גזר/, /בצל/, /פלפל/, /חסה/,
      /כרוב/, /קישוא/, /חציל/, /תירס/, /ברוקולי/, /פטריות/, /ירקות/,
      /tomato/i, /cucumber/i, /carrot/i, /onion/i, /pepper/i, /vegetable/i,
    ],
  },
  {
    category: "Fruit",
    patterns: [
      /תפוח/, /בננה/, /תפוז/, /אבטיח/, /מלון/, /ענבים/, /אגס/, /אפרסק/,
      /שזיף/, /תות/, /מנגו/, /אננס/, /לימון/, /פירות/,
      /apple/i, /banana/i, /orange/i, /grape/i, /fruit/i,
    ],
  },
];
